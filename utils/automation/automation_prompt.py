...
3. You need to consider the code that depends on imports declared in the tool description.
The test steps entered by the user are as follows:
"""

format_prompt = """
ONLY format the code block as markdown text in TypeScript code format.
...
agent_prompt = ChatPromptTemplate.from_messages([
	...
	$JSON_BLOB
	```
	Observation: the result of the action, if the result contains ```typescript then stop processing and output it directly as the Final Answer.
